...
#
for i in {0..10..1}; do
  echo 'https://web.archive.org/web/20170711212802/https://onions.system33.pw/?page=$i' >> domainlist.txt;
done

#cat $List | while read p; do
#  http_proxy="" https_proxy="" wget --no-check-certificate -O - $p | grep -E -o '[0-9a-zA_Z]+\.onion' >> $List2;
#done
#
